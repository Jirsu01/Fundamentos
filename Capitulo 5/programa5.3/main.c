...
int main(void) {
  ...
  *IX = 1; /* X toma el valor 1. ahora vale 1 */
  printf("\nX = %d \t Y = %d \t Z[0] = %d \t Z[1] = %d \t Z[2] = %d \t Z[3] = %d \t Z[4] = %d", X, Y, Z[0], Z[1], Z[2], Z[3], Z[4]);
  ...
  *IX += 1; /* Z[2] se modifica, se incrementa en 1. Z[2] ahora vale 12. */
  printf("\nX = %d \t Y = %d \t Z[0] = %d \t Z[1] = %d \t Z[2] = %d \t Z[3] = %d \t Z[4] = %d", X, Y, Z[0], Z[1], Z[2], Z[3], Z[4]);
  ...
  IX = IX + 1; /* IX se reasigna, ahora apunta al cuarto elemento del arreglo Z. */
  Y = *IX; /* Y se modifica, toma el valor de Z[3] (8). */
  printf("\nX = %d \t Y = %d \t Z[0] = %d \t Z[1] = %d \t Z[2] = %d \t Z[3] = %d \t Z[4] = %d", X, Y, Z[0], Z[1], Z[2], Z[3], Z[4]);
}